...
<section>
   ...
   <div id="main-content">
      <div id="section-one">
        ...
        <a href="#"><img src="<?php echo get_images_url('1.jpg');?>" alt="sliderImg1" title="<p>Flexible and functional</p> <span>Easy to modify and customize</span>" /></a>
        <a href="#"><img src="<?php echo get_images_url('2.jpg');?>" alt="sliderImg2" title="<p>Modern minimalist portfolio</p> <span>Packed with HTML5 and CSS3 goodness</span>" /></a>
        <a href="#"><img src="<?php echo get_images_url('3.jpg');?>" alt="sliderImg3" title="<p>Grid 960 System</p> <span>Suoer easy layout customization</span>" /></a>
        <a href="#"><img src="<?php echo get_images_url('4.jpg');?>" alt="sliderImg4" title="<p>Okay you get the hang of it</p> <span>Another caption here</span>" /></a>
       </div>
       <div id="shadow"></div>
      </div> 

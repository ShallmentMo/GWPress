<?php
	...
	if($_POST['action']=='page_edit')
	{
        ...
        <table>
				...
				<tr><td>page_template</td><td><input type='text' name='page_template' value='<?php echo get_page_template($_POST['page_id']);?>'/></td></tr>
	...
	?>
        ...
        <table>
				...
				<tr><td>page_template</td><td><input type='text' name='page_template' value=''/></td></tr>
